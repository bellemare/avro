...
public class TestSchemas {
  ...
  static final Schema ENUM_ABC_FIELD_DEFAULT_A_RECORD = Schema.createRecord("Record", null, null, false);
  static final Schema ENUM_AB_FIELD_DEFAULT_A_RECORD = Schema.createRecord("Record", null, null, false);
  ...
  static {
    ...
    ENUM_ABC_ENUM_DEFAULT_A_RECORD.setFields(
      list(new Schema.Field("Field", Schema.createEnum("Schema", null, null, list("A","B","C"), null), null, "A")));
    ENUM_AB_ENUM_DEFAULT_A_RECORD.setFields(
      list(new Schema.Field("Field", Schema.createEnum("Schema", null, null, list("A","B"), null), null, "A")));
    ENUM_ABC_FIELD_DEFAULT_B_ENUM_DEFAULT_A_RECORD.setFields(
      list(new Schema.Field("Field", Schema.createEnum("Schema", null, null, list("A","B","C"), "B"), null, "A")));
    ENUM_AB_FIELD_DEFAULT_A_ENUM_DEFAULT_B_RECORD.setFields(
      list(new Schema.Field("Field", Schema.createEnum("Schema", null, null, list("A","B"), "A"), null, "B")));
  }

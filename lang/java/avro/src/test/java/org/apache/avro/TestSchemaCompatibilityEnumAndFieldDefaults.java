...
public class TestSchemaCompatibilityEnumAndFieldDefaults {
  @Rule
  ...
  @Test
  public void testEnumDefaultApplied() throws Exception {
    Schema writerSchema = SchemaBuilder.record("Record1").fields()
  ...
  @Test
  public void testEnumDefaultAppliedBeforeFieldDefault() throws Exception {
    Schema writerSchema = SchemaBuilder.record("Record1").fields()
      .name("field1").type(ENUM_ABC_ENUM_DEFAULT_A_SCHEMA).noDefault()
      .endRecord();

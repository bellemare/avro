...
import static org.apache.avro.TestSchemas.ENUM_AB_FIELD_DEFAULT_A_RECORD;
import static org.apache.avro.TestSchemas.ENUM_ABC_FIELD_DEFAULT_A_RECORD;
...
public class TestSchemaCompatibility {
  ...
  public static final List<ReaderWriter> COMPATIBLE_READER_WRITER_TEST_CASES = list(
      ...
      new ReaderWriter(ENUM_AB_FIELD_DEFAULT_A_RECORD, ENUM_ABC_FIELD_DEFAULT_A_RECORD),
